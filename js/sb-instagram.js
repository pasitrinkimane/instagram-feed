 ...
 */
    ...
    * */
    ...
    // add links to page
    var addLinks = {
        regexString: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", hashtags: function (e) {
            var t = "";
            var n, r, i, s, o, u, a;
            var f = 0;
            ...
            jQuery('#sb_instagram.sbi').each(function (index) { //Ends on line 1676
                ...
                function sbiCreateFeed(feed, var_this, feedOptions) {
                    ...
                    function sbiBuildFeed(feed, images, transientName, sbiSettings, $self) {
                        ...
                        var highlightType = typeof highlight !== 'undefined' ? highlight[0] : 'pattern',
                            hashtagsToHighlight = [],
                            idsToHighlight = [];
                        ...
                        jQuery.each(imagesArr.data, function (itemNumber, item) { // itemNumber = index, item = value
                            ...
                            //Hover display info
                            if (feedOptions.hoverdisplay.indexOf('location') > -1) {
                                var showHoverLocation = true;
                            } else {
                                var showHoverLocation = false;
                            }
                            if (feedOptions.hoverdisplay.indexOf('caption') > -1) {
                                var showHoverCaption = true;
                            } else {
                                var showHoverCaption = false;
                            }
                            if (feedOptions.hoverdisplay.indexOf('likes') > -1) {
                                var showHoverLikes = true;
                            } else {
                                var showHoverLikes = false;
                            }
                            if (feedOptions.hoverdisplay.indexOf('username') > -1) {
                                var showHoverUsername = true;
                            } else {
                                var showHoverUsername = false;
                            }
                            if (feedOptions.hoverdisplay.indexOf('icon') > -1) {
                                var showHoverIcon = true;
                            } else {
                                var showHoverIcon = false;
                            }
                            if (feedOptions.hoverdisplay.indexOf('date') > -1) {
                                var showHoverDate = true;
                            } else {
                                var showHoverDate = false;
                            }
                            if (feedOptions.hoverdisplay.indexOf('instagram') > -1) {
                                var showHoverInstagram = true;
                            } else {
                                var showHoverInstagram = false;
                            }
                        ...
                        if (((imagesArrCount - imagesArrCountOrig) < num) && (photosAvailable < num) /*&& (numberOfPhotosDisplayed < num)*/ && (apiRequests < maxRequests) && !noMoreData && (imagesArrCount < numWhiteListIds || feedOptions.sbiWhiteList === '')) { //Also check here whether next_url is available. If it's not then don't try to get more photos.
                            ...
                            var test = '<div class="sbi_item sbi_type_carousel" id="" data-date="0" style=""><div class="sbi_photo_wrap"><svg class="svg-inline--fa fa-clone fa-w-16 sbi_lightbox_carousel_icon" aria-hidden="true" data-fa-processed="" data-prefix="far" data-icon="clone" role="presentation" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M464 0H144c-26.51 0-48 21.49-48 48v48H48c-26.51 0-48 21.49-48 48v320c0 26.51 21.49 48 48 48h320c26.51 0 48-21.49 48-48v-48h48c26.51 0 48-21.49 48-48V48c0-26.51-21.49-48-48-48zM362 464H54a6 6 0 0 1-6-6V150a6 6 0 0 1 6-6h42v224c0 26.51 21.49 48 48 48h224v42a6 6 0 0 1-6 6zm96-96H150a6 6 0 0 1-6-6V54a6 6 0 0 1 6-6h308a6 6 0 0 1 6 6v308a6 6 0 0 1-6 6z"></path></svg><svg class="svg-inline--fa fa-play fa-w-14 sbi_playbtn" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="play" role="presentation" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M424.4 214.7L72.4 6.6C43.8-10.3 0 6.1 0 47.9V464c0 37.5 40.7 60.1 72.4 41.3l352-208c31.4-18.5 31.5-64.1 0-82.6z"></path></svg><div class="sbi_link sbi_default"><div class="sbi_hover_top"></div><div class="sbi_hover_bottom" style="color: rgba(255,255,255,1)"><p></p></div><a class="sbi_link_area nofancybox" href="https://www.instagram.com/p/ByxEn5NHiHp/media?size=l" data-lightbox-sbi="1" data-title="Vasarai ir tokiems karščiams atėjus visi deginasi, maudosi, buna su draugais, kai kurie dirba, bet kaip vasarą be ledų? Mano pagrindinis ,galima sakyti, dienos maistas Nykštuko ledai ir naujiena Bubble gum.😁 Tai itin geras būdas atsigaivinti, o kaip jūs atsigaivinat?😁#Nykstukoledai #nykstukas Pienozvaigzdesab #kelknykstį #ad" data-video="" data-carousel="{&quot;0&quot;:{&quot;type&quot;:&quot;image&quot;,&quot;media&quot;:&quot;https://scontent.xx.fbcdn.net/v/t51.2885-15/65093584_1089031184614978_6890989596308820380_n.jpg?_nc_cat=100&amp;_nc_ht=scontent.xx&amp;oh=5cec47620cb9106eb605faa1f5129afe&amp;oe=5D9316B6&quot;},&quot;1&quot;:{&quot;type&quot;:&quot;image&quot;,&quot;media&quot;:&quot;https://scontent.xx.fbcdn.net/v/t51.2885-15/61208628_2833676573371387_8578554449913785859_n.jpg?_nc_cat=110&amp;_nc_ht=scontent.xx&amp;oh=1e57e1b9bf83df898dfe6b6e540c03d2&amp;oe=5D8E7BDE&quot;},&quot;2&quot;:{&quot;type&quot;:&quot;image&quot;,&quot;media&quot;:&quot;https://scontent.xx.fbcdn.net/v/t51.2885-15/64748128_1615453895254718_8165031862012758462_n.jpg?_nc_cat=102&amp;_nc_ht=scontent.xx&amp;oh=cb35f12a4f9bee1cd3087fbfbf640853&amp;oe=5D8AF4AF&quot;}}" data-id="sbi_18042046297159645" data-user="" data-url="https://www.instagram.com/p/ByxEn5NHiHp/" data-avatar="" data-account-type="business"><span class="sbi-screenreader">Link to display lightbox</span><svg style="color: rgba(255,255,255,1)" class="svg-inline--fa fa-play fa-w-14 sbi_playbtn" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="play" role="presentation" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M424.4 214.7L72.4 6.6C43.8-10.3 0 6.1 0 47.9V464c0 37.5 40.7 60.1 72.4 41.3l352-208c31.4-18.5 31.5-64.1 0-82.6z"></path></svg><span class="sbi_lightbox_link" style="color: rgba(255,255,255,1)"></span></a></div><a class="sbi_photo" href="https://www.instagram.com/p/ByxEn5NHiHp/" target="_blank" rel="noopener" role="img" aria-label="Image for post 18042046297159645"><img src="https://www.instagram.com/p/ByxEn5NHiHp/media?size=m" alt="Vasarai ir tokiems karščiams atėjus visi deginasi, maudosi, buna su draugais, kai kurie dirba, bet kaip vasarą be ledų? Mano pagrindinis ,galima sakyti, dienos maistas Nykštuko ledai ir naujiena Bubble gum.😁 Tai itin geras būdas atsigaivinti, o kaip jūs atsigaivinat?😁#Nykstukoledai #nykstukas Pienozvaigzdesab #kelknykstį #ad" width="200" height="200"></a></div><div class="sbi_info"><p class="sbi_caption_wrap" style="display: none;"><span class="sbi_caption" style="color: #; font-size: 13px;">Vasarai ir tokiems karščiams atėjus visi deginasi,</span><span class="sbi_expand" style="display: inline;"> <a href="#"><span class="sbi_more">...</span></a></span></p><div class="sbi_meta" style="color: #; display: none;"><span class="sbi_likes" style="font-size: 13px;"><svg style="font-size: 13px;" class="svg-inline--fa fa-heart fa-w-18" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="heart" role="presentation" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentColor" d="M414.9 24C361.8 24 312 65.7 288 89.3 264 65.7 214.2 24 161.1 24 70.3 24 16 76.9 16 165.5c0 72.6 66.8 133.3 69.2 135.4l187 180.8c8.8 8.5 22.8 8.5 31.6 0l186.7-180.2c2.7-2.7 69.5-63.5 69.5-136C560 76.9 505.7 24 414.9 24z"></path></svg>5,536</span><span class="sbi_comments" style="font-size: 13px;"><svg style="font-size: 13px;" class="svg-inline--fa fa-comment fa-w-18" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="comment" role="presentation" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentColor" d="M576 240c0 115-129 208-288 208-48.3 0-93.9-8.6-133.9-23.8-40.3 31.2-89.8 50.3-142.4 55.7-5.2.6-10.2-2.8-11.5-7.7-1.3-5 2.7-8.1 6.6-11.8 19.3-18.4 42.7-32.8 51.9-94.6C21.9 330.9 0 287.3 0 240 0 125.1 129 32 288 32s288 93.1 288 208z"></path></svg>14</span></div></div></div>'
                            if (typeof imagesHTML !== 'undefined') {
                                $self.find('#sbi_images').append(imagesHTML);
                                if (typeof imagesForInstagram !== 'undefined') {
                                    imagesForInstagram.map(function (item) {
                                        $self.find('#sbi_images').append(item);
                                    })
                                }
                            }

                            // console.log($self.find('#sbi_images').html())
                        ...
                        function sbiAfterImagesLoaded(feed, imagesArr, transientName) {
                            ...
                            $self.find('.sbi_item').each(function () {
                                ...
                                if (brAdjust && brCount > 0 && full_text.indexOf('<br>') < text_limit) {
                                    var captionPadding = $post_text.closest('.sbi_caption_wrap').css("padding-left"),
                                        captionWidth = $post_text.closest('.sbi_caption_wrap').width() - (parseInt(captionPadding) * 2),
